 ...
 */
export interface CreateDelegationOptions extends BaseCreateDelegationOptions {
  to: Hex;
}
 ...
 */
export interface CreateOpenDelegationOptions
  extends BaseCreateDelegationOptions {}
